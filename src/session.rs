...
pub struct WsChatSession {
    ...
    pub db_conn: web::Data<Mutex<SqliteConnection>>, // Updated to use Mutex<SqliteConnection>
}
            ...
            ws::Message::Text(text) => {
                ...
                match &input.chat_type {
                    ...
                    ChatType::TEXT => {
                        ...
                        let mut conn = self.db_conn.lock().unwrap(); // Lock the Mutex to access the connection
